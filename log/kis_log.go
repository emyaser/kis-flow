...
// 日志模块KisFlow提供一个默认的标准输出Logger对象
// 再对我开放一个SetLogger()方法来进行重新设置开发者自己的Logger模块
// KisLogger提供了三个级别的日志，分别是Info、Error、Debug
// 分别提供了具备context参数与不具备context参数的两套日志接口
// 提供一个全局对象kisLog，默认的KisLog 对象
// 方法SetLogger()和Logger()供开发者可以设置自己的Logger对象以及获取到Logger对象
